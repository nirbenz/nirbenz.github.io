...
## This is our own local (Machine and Deep Learning Israel) version of (Stanford's original course guide)[https://github.com/cs231n/gcloud]. Some things have been modified. 
...
{{ site.baseurl }}/images/orig_guide src="{{ site.baseurl }}/images/orig_guide/machine-typ.png" width="50%">
...
{{ site.baseurl }}/images/orig_guide src="{{ site.baseurl }}/images/orig_guide/network.png" width="70%">

Firewall Rules:

{{ site.baseurl }}/images/orig_guide src="{{ site.baseurl }}/images/orig_guide/firewall.png" width="70%">
