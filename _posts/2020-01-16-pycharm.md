...
# Using PyCharm with Remote Instances
...
![first time]({{ site.baseurl }}/images/pycharm/gcp_ssh1.png)

And *paste* the public key you have copied like below:

![first time]({{ site.baseurl }}/images/pycharm/gcp_ssh2.png)
...
![first time]({{ site.baseurl }}/images/pycharm/pycharm1.png)
...
![first time]({{ site.baseurl }}/images/pycharm/pycharm2.png)

Click the cogwheel at the top right and a new window will open.

![first time]({{ site.baseurl }}/images/pycharm/pycharm3.png)
...
![first time]({{ site.baseurl }}/images/pycharm/pycharm4.png)
...
![first time]({{ site.baseurl }}/images/pycharm/pycharm5.png)
