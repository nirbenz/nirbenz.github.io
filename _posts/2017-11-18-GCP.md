...
Remember when we said Windows is very problematic for Deep Learning? This guide will demonstrate this beautifully :-)
...
Running the final `./google-cloud-sdk/bin/gcloud init` command should look like this:
...
If you get that error during script execution, execute the following 3 lines before running the script. In the menu that loads up simply hit **Enter** until done. Afterwards, run the script again.
