...
You should enter **only using the email address associated with the Google account you will be using!**. For *Comapny Legal Name* use your own name, and for the domain put your school domain as a placeholder. For Concat Name enter your name **again**.
