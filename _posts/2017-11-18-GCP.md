...
This is a guide for setting up Google Cloud Engine for the course. I have obviously stolen a lot from the [original course guide](http://cs231n.github.io/gce-tutorial/), but this is intended to be a standalone guide.
...
If this is indeed your first time you should receive some free trial credits from Google, so those should suffice for the purpose of this guide. Following this guide we will need you to share your email address with us so we could hook it up with the free credits. Use the [Facebook group](https://www.facebook.com/groups/553903248285761/) for this.
