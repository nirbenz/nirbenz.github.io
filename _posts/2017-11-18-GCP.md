...
The GCP SDK is a bunch of command-line utilities which we will need throughout the course. Go ahead and follow [Google's guide to downloading and installing those](https://cloud.google.com/sdk/docs/). Perform the **optional Step 4**.
